...
class NYCwindowDataset_TxC(DownscalingDataset):
    ...
    def _load_dataset(self, data_path):
        ...
        path_input_data = data_path+'/leap/NYC_data_128/data_input_expanded_TxC.nc'
        path_output_data = data_path+'/leap/NYC_data_128/data_output_expanded_TxC.nc'
    ...
    def _load_stats(self, data_path, input_variables, output_variables):
        ...
        stats_in = xr.open_dataset('/leap/NYC_data_128/input_stats_expanded_TxC.nc')
        stats_out = xr.open_dataset('/leap/NYC_data_128/output_stats_expanded_TxC.nc')
...
class NYCwindowDataset_old(DownscalingDataset):
    ...
    def _load_dataset(self, data_path):
        ...
        path_input_vars = data_path+'/leap/NYC_data_128/ERA5_hrrr_interp_128_2020_2025_v2.nc'
