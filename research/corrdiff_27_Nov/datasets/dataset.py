...
from datasets import base, cwb, hrrrmini, gefs_hrrr, nyc, nyc_window, SSH_SST, nyc_window_TxC
...
known_datasets = {
    ...
    "nyc": nyc.NYCDataset,
    "nyc_window": nyc_window.NYCwindowDataset,
    "nyc_window_TxC": nyc_window_TxC.NYCwindowDataset_TxC,
    "ssh_sst": SSH_SST.SSH_SST_Dataset
}
