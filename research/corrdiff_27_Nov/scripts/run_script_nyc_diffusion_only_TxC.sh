...
CONTAINER=/home/lep-bvtph/leap/mike_testing/physicsnemo-2511-corrdiff.simg
...
APP_CMD="/leap/DB_scratch/physicsnemo/research/corrdiff_27_Nov/train_only_diffusion.py --config-name=config_training_nyc_window_diffusion_no_reg_TxC.yaml"

srun apptainer exec --bind /home/lep-bvtph/leap:/leap --nv $CONTAINER torchrun $RUN_CMD $APP_CMD